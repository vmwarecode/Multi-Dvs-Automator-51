...
> Forward and reverse DNS settings for nsx and esxi components should be preconfigured.
 ...
 ** No shared NSX instance was found, you need to create a new one
 ...
 Enter FQDN for 1st NSX Manager: nsxt-manager-1.vrack.vsphere.local
 Resolving IP from DNS...
 Resolved IP address: 10.0.0.193



 Enter FQDN for 2nd NSX Manager: nsxt-manager-2.vrack.vsphere.local
 Resolving IP from DNS...
 Resolved IP address: 10.0.0.194



 Enter FQDN for 3rd NSX Manager: nsxt-manager-3.vrack.vsphere.local
 Resolving IP from DNS...
